var quotes = [
  ...
  {quote: "Play it again, Sam!",
   source: "Humphrey Bogart", citation: "This phrase never actually occurs in the film 'Cassablanca'.", tag: "fake"},
  ...
  {quote: "All that is necessary for the triumph of evil, is that good men should do nothing.",
   source: "Edmund Burke", citation: "There's no evidence Burke ever said this.", tag: "fake"},
  {quote: "Elementary, Watson!",
   source: "Sherlock Holmes", citation: "Conan Doyle's original character never uttered these words.", tag:  "fake"},
  {quote: "Money is the root of all evil.",
   source: "St Paul", citation: "This phrase occurs nowhere in the Bible.", tag: "fake"},
