var quotes = [
  ...
  {quote: "Play it again, Sam!",
   source: "Humphrey Bogart", citation: "but this phrase never actually occurs in the film 'Cassablanca'.", tag: "fake"},
  ...
  {quote: "All that is necessary for the triumph of evil, is that good men should do nothing.",
   source: "Edmund Burke", citation: "but there's no evidence Burke ever said this.", tag: "fake"},
  {quote: "Elementary, Watson!",
   source: "Sherlock Holmes", citation: "but Conan Doyle's original character never uttered these words.", tag:  "fake"},
